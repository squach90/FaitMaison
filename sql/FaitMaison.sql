...
--
-- Host: localhost:8889
-- Generation Time: Jul 23, 2025 at 05:16 PM
...
--
-- Database: `sitederecette`
--
CREATE DATABASE IF NOT EXISTS `sitederecette` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `sitederecette`;
...
INSERT INTO `user` (`user_id`, `full_name`, `email`, `password`, `age`) VALUES
(1, 'Louis Lesniak', 'louis@lesniak.fr', 'devine', 13);
